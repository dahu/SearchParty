...
nmap <silent> <leader>mar      <Plug>SearchPartySearchHighlightReplace
nmap          <leader>mm       <Plug>SearchPartySetMatch<CR>
nmap <silent> <leader>ms       <Plug>SearchPartySetSearch
nmap <silent> <leader>mah      <Plug>SearchPartyToggleAutoHighlightWord

" Visual Mode

xmap <silent> <leader>*        <Plug>SearchPartyHighlightVisual
xmap <silent> <leader>mar      <Plug>SearchPartySearchHighlightReplace
